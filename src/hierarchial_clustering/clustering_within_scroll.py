...
from src.hierarchial_clustering.hc_utils import hirerchial_clustering_by_scroll_gnn
from src.hierarchial_clustering.scrolls_labeling import (
    labels_1QS,
    labels_hodayot,
    labels_1QM,
)
...
def get_metrics_per_model(
    ...
    for scroll, labels in labels_all.items():
        metrics_gnn = hirerchial_clustering_by_scroll_gnn(
            ...
            eval(scroll),
            labels,
            f"GVAE={bert_model} + TF-IDF edges",
            embeddings_gvae,
