...
if __name__ == "__main__":
    # run_gvae_n_iters(10, domain="dss",  dataset="dataset_scroll", is_supervised=False,df_frac_remove=0.1, file_name=f"{BASE_DIR}/experiments/dss/gnn/gvae_cv/gvae_cv_book_1_adj_types.csv", num_combined_graphs=1)
